...
class MyCrawler:
    ...
    def crawling(self,seeds,crawl_deepth):
        ...
        while not self.linkQuence.unVisitedUrlsEnmpy():
            ...
            #获取超链接
            pages=self.getPagesHyperLinks(visitUrl,"pagenum")
            links=self.getPagesHyperLinks(visitUrl,"mainbody")
    ...
    def crawl_page_urls(self, urls):
        ...
        for url in urls:
            ...
            for target_url in target_urls:
                if target_url not in self.linkQuence.getVisitedUrl():
